...
- WCAG AA contrast test covering the foreground/background pairs the GTK2, GTK3, GTK4 and Xfwm4 templates emit, across all 24 combinations. Text pairs only — WCAG 1.4.3; non-text contrast (1.4.11) is not yet gated.
